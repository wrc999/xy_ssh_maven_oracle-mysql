...
_44.droppables=_46;
var _48=_44.proxy_ssh;
if(!_48){
if(_45.proxy_ssh){
if(_45.proxy_ssh=="clone"){
_48=$(e.data.target).clone().insertAfter(e.data.target);
}else{
_48=_45.proxy_ssh.call(e.data.target,e.data.target);
}
_44.proxy_ssh=_48;
}else{
_48=$(e.data.target);
...
_f1.disabledNodes=[];
_f2.dnd=true;
_f3.find("div.tree-node").draggable({disabled:false,revert:true,cursor:"pointer",proxy_ssh:function(_f4){
...
var icon=$(_105).draggable("proxy_ssh").find("span.tree-dnd-icon");
...
_293.pmask=$("<div class=\"window-proxy_ssh-mask\"></div>").insertAfter(_293.window);
...
if(_293.proxy_ssh){
_293.proxy_ssh.remove();
}
_293.proxy_ssh=$("<div class=\"window-proxy_ssh\"></div>").insertAfter(_293.window);
_293.proxy_ssh.css({display:"none",zIndex:$.fn.window.defaults.zIndex++,left:e.data.left,top:e.data.top});
_293.proxy_ssh._outerWidth(e.data.width)._outerHeight(e.data.height);
_293.proxy_ssh.hide();
setTimeout(function(){
if(_293.pmask){
_293.pmask.show();
...
_293.pmask.show();
_293.proxy_ssh.css({display:"block",left:e.data.left,top:e.data.top});
_293.proxy_ssh._outerWidth(e.data.width);
_293.proxy_ssh._outerHeight(e.data.height);
};
...
var _3c2=$(">div.layout-split-proxy_ssh-v",_3ba);
}else{
var _3c2=$(">div.layout-split-proxy_ssh-h",_3ba);
}
...
if(dir=="north"||dir=="south"){
var _3c5=$(">div.layout-split-proxy_ssh-v",_3ba);
_3c5.css("top",e.pageY-$(_3ba).offset().top-_3c5.height()/2);
}else{
var _3c5=$(">div.layout-split-proxy_ssh-h",_3ba);
...
if(!_693.proxy_ssh){
_693.proxy_ssh=$("<div class=\"datagrid-resize-proxy_ssh\"></div>").appendTo(dc.view);
}
_693.proxy_ssh.css({left:e.pageX-$(_694).offset().left-1,display:"none"});
setTimeout(function(){
if(_693.proxy_ssh){
_693.proxy_ssh.show();
}
...
_693.proxy_ssh.css({left:e.pageX-$(_694).offset().left-1,display:"block"});
return false;
},onStopResize:function(e){
_695.css("cursor","");
$(this).css("height","");
