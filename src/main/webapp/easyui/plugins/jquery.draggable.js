...
_d.droppables=_f;
var _11=_d.proxy_ssh;
if(!_11){
if(_e.proxy_ssh){
if(_e.proxy_ssh=="clone"){
_11=$(e.data.target).clone().insertAfter(e.data.target);
}else{
_11=_e.proxy_ssh.call(e.data.target,e.data.target);
}
_d.proxy_ssh=_11;
}else{
_11=$(e.data.target);
...
$.fn.draggable.defaults={proxy_ssh:null,revert:false,cursor:"move",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,delay:100,onBeforeDrag:function(e){
