...
_13.disabledNodes=[];
_14.dnd=true;
_15.find("div.tree-node").draggable({disabled:false,revert:true,cursor:"pointer",proxy_ssh:function(_16){
var p=$("<div class=\"tree-node-proxy_ssh\"></div>").appendTo("body");
...
$(this).draggable("proxy_ssh").css({left:-10000,top:-10000});
...
var _2a=$(_28).draggable("proxy_ssh").find("span.tree-dnd-icon");
