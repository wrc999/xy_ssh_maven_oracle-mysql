...
if(!_77.proxy_ssh){
_77.proxy_ssh=$("<div class=\"datagrid-resize-proxy_ssh\"></div>").appendTo(dc.view);
}
_77.proxy_ssh.css({left:e.pageX-$(_78).offset().left-1,display:"none"});
setTimeout(function(){
if(_77.proxy_ssh){
_77.proxy_ssh.show();
}
...
_77.proxy_ssh.css({left:e.pageX-$(_78).offset().left-1,display:"block"});
return false;
