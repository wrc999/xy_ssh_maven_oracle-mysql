...
_16.onAdd=_17;
cc.append("<div class=\"layout-split-proxy_ssh-h\"></div><div class=\"layout-split-proxy_ssh-v\"></div>");
...
var _23=$(">div.layout-split-proxy_ssh-v",_1a);
}else{
var _23=$(">div.layout-split-proxy_ssh-h",_1a);
}
...
if(dir=="north"||dir=="south"){
var _27=$(">div.layout-split-proxy_ssh-v",_1a);
_27.css("top",e.pageY-$(_1a).offset().top-_27.height()/2);
}else{
var _27=$(">div.layout-split-proxy_ssh-h",_1a);
_27.css("left",e.pageX-$(_1a).offset().left-_27.width()/2);
}
return false;
},onStopResize:function(e){
cc.children("div.layout-split-proxy_ssh-v,div.layout-split-proxy_ssh-h").hide();
