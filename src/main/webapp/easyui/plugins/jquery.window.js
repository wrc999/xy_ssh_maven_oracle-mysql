...
_23.pmask=$("<div class=\"window-proxy_ssh-mask\"></div>").insertAfter(_23.window);
...
if(_23.proxy_ssh){
_23.proxy_ssh.remove();
}
_23.proxy_ssh=$("<div class=\"window-proxy_ssh\"></div>").insertAfter(_23.window);
_23.proxy_ssh.css({display:"none",zIndex:$.fn.window.defaults.zIndex++,left:e.data.left,top:e.data.top});
_23.proxy_ssh._outerWidth(e.data.width)._outerHeight(e.data.height);
_23.proxy_ssh.hide();
setTimeout(function(){
if(_23.pmask){
_23.pmask.show();
...
_23.pmask.show();
_23.proxy_ssh.css({display:"block",left:e.data.left,top:e.data.top});
_23.proxy_ssh._outerWidth(e.data.width);
_23.proxy_ssh._outerHeight(e.data.height);
};
function _26(e,_27){
