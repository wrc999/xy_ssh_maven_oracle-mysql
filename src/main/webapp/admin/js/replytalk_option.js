...
$("#btn_Query").click(function(){
  url="/xy_ssh_oracle_maven/reply/Replyget";
...
$("#btn_Add").click(function(){
  ...
  $("#fm_user").form("clear");
  url = "/xy_ssh_oracle_maven/reply/Replytalkadd";
});
...
$("#btn_Edit").click(function(){
  ...
  url = "/xy_ssh_oracle_maven/reply/Replytalkedit";
});
...
$("#btn_Del").click(function(){
  ...
  url = "/xy_ssh_oracle_maven/reply/Replydelete";
  var id = row.id;
