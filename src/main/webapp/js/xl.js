...
$(document).ready(function(){
    ...
    //单击退出，清空cookie并刷新页面
$("#quit").click(function(){
	$.removeCookie('account',{path:"/xy_ssh_oracle_maven"});
	$.removeCookie('use_id',{path:"/xy_ssh_oracle_maven"});
...
//单击查询动态
$("#bt2").click(function(){
	url="/xy_ssh_oracle_maven/Talk_get";
...
function talkRequest(){
	$.post(url,param,function(data){
		...
		$(".bt5").click(function(){
			...
			$.ajax({
				url:"/xy_ssh_oracle_maven/TalkCollect_add",
				type:"post",
				data:{
		...
		$(".bt6").click(function(){
			...
			url="/xy_ssh_oracle_maven/ReplyTalk_get";
...
//评论的Ajax请求
		...
		$(".bt7").click(function(){
			...
			url="/xy_ssh_oracle_maven/ReplyTalk_add";
			$.ajaxSetup({
		        async: false
		    });
			$.post(url,param,function(data){});
...
$(".list-group-item").click(function(){
	...
	url="/xy_ssh_oracle_maven/TalkCollect_find";
...
function collectRequest(){
	$.post(url,param,function(data){
		...
		$(".ddd").click(function(){
			...
			use_id = $.cookie("use_id");
			url="/xy_ssh_oracle_maven/TalkCollect_delete";
