 var url=null;
    ...
    $(document).ready(function(){
        ...
        //单击退出，清空cookie并刷新页面
    $("#quit").click(function(){
    	$.removeCookie('account',{path:"/xy_ssh_oracle_maven_oracle_maven_oracle_maven"});
    	$.removeCookie('use_id',{path:"/xy_ssh_oracle_maven_oracle_maven_oracle_maven"});
	...
	function a(){
		  	$.ajax({
			  	url:"/xy_ssh_oracle_maven/user_get",
			  	type:"post",
     ...
     $(document).ready(function(){
		...
		b();
    	 ...
    	 function b(){
 		  	$.ajax({
 			  	url:"/xy_ssh_oracle_maven/user_edit",
 			  	type:"post",
 			  	//data:$("#condition").serialize(),
 			  	data:{
 			  		'use_id':use_id,
 ...
 function c(){
	 $.ajax({
		 url:"/xy_ssh_oracle_maven/user_PassWordEdit",
		 type:"post",
		 datatype:"json",
		 data:{
			 'account':account,
 ...
 function d(){
	 $.ajax({
		 url:"/xy_ssh_oracle_maven/suggest_add",
		 type:"post",
		 datatype:"json",
		 data:{
			 'use_id':use_id,
 ...
 function judgeEntryYear(){
	...
	$(document).ready(function(){
		use_id = $.cookie("use_id");
		condition = null;
		url="/xy_ssh_oracle_maven/talkCollect_get";
	...
	function collectRequest(){
		$.post(url,param,function(data){
			...
			$(".ddd").click(function(){
				...
				use_id = $.cookie("use_id");
				url="/xy_ssh_oracle_maven_oracle_maven_oracle_maven/TalkCollect_delete";
